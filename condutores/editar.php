...
<body>
    <form name="condutores" action="editar-ok.php" method="post">
        <table>
            <tr>
                <th colspan=2>Cadastro de Condutores - Alteração</th>
            </tr>
            <tr>
                <td>CNH</td>
                <td><input type="text" name="cnh" size=15 maxlength=15 readonly value=<?php echo $codigo; ?>></td>
            </tr>
            <tr>
                <td>Nome</td>
            ...
            <tr>
                ...
                <td><input type="date" name="nasc" size=10 maxlength=10 required value=<?php echo $dado['nasc']; ?>></td>
            </tr>
            <tr>
